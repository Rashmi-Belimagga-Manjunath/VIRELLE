...
GOOGLE_SHEET_URL = os.getenv(
    ...
    "",  # Single-tab mode: paste your published CSV URL here
)
GOOGLE_SHEET_URLS = os.getenv(
    "VIRELLE_GOOGLE_SHEET_URLS",
    "",  # Multi-tab mode: JSON dict of tab→URL, e.g. '{"Hotel":"...&gid=0","Rooms":"...&gid=1"}'
)
